  ...
  <div class="container-fluid text-center w-75 m-auto p-5 " style="color: #555555;" id="about">
    ...
    <c:choose>
      <c:when test="${empty events}">
        <h1 class="mt-5">There is No Events and Packages</h1>
      </c:when>
      <c:otherwise>
        <h1 class="mt-5">${events[0].event}</h1>
                ...
                <div class="card p-3 border border-3 bg-light">
                  ...
                  <div class="card-body row row-cols-1 row-cols-md-4 g-2 ">
                    ...
                    <div class="col">
                      ...
                      <h6>${event.chairrate }&#8377;</h6>
                    </div>
                    <div class="col">
                      Decoration Rate:<br>
                      <h6>${event.decoration }&#8377;</h6>
                    </div>
                  </div>
                  <div>
                    <a href="events/eventedit/${event.eventid}"
                      class="btn bg-color fs-5 px-5 border border-black fw-bold">Edit
                      Package</a>
                    <a href="events/eventdelete/${event.eventid}" class="fs-1 fw-bold float-end px-5 "> <abbr
                        title="Delete"><i class="fa-solid fa-trash" style="color: #cf0707;"></i></abbr></a>
        ...
        <a href="homepage" class="btn bg-color fs-5 px-5 border border-black fw-bold">Go To Home Page</a>
        <%-- <form action="homepagereturn" method="post">
          <input type="email" class="form-control" id="inputEmail3" name="email" value="${user.email }" hidden>

          <button type="submit" class="btn bg-color fs-5 px-5 border border-black fw-bold">Go To Home Page</button>
