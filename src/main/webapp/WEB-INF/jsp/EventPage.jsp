    ...
    <c:choose>
      ...
      <c:otherwise>
        <div class="input-group">
          <input type="text" id="searchInput" class="form-control" placeholder="Search for an event..."
            onkeyup="filterEvents()">
        </div>

        <div class="cards my-5">
          <div class="row row-cols-1 row-cols-md-1 g-4" id="EventContainer">
                ...
                <div class="card p-3 border border-3 bg-light">
                  ...
                  <div>
                    ...
                    <c:forEach var="booking" items="${mybookings}">
                      ...
                      <c:choose>
                        <c:when test="${booking.event.eventid == event.eventid}">
                    ...
                    <c:choose>
                      ...
                      <c:otherwise>
                        ...
                        <c:forEach var="bookmark" items="${bookmarks}">
                          ...
                          <c:choose>
                            <c:when test="${bookmark.event.eventid==event.eventid}">
                              <c:set var="present" scope="page" value="true" />
                            </c:when>
                          </c:choose>
                        </c:forEach>
                        ...
                        <c:choose>
                          <c:when test="${present}">
                            <span class="fs-5 px-5 fw-bold float-end">Bookmarked</span>
                          </c:when>
                          <c:otherwise>
                            <a href="events/bookmark/${event.eventid}" class="fs-5 px-5 fw-bold float-end"><i
                                class="fa-regular fa-bookmark fs-3"></i><br>Save</a>
                          </c:otherwise>
                        </c:choose>
                      </c:otherwise>
                    </c:choose>
...
<script>
  function filterEvents() {
    ...
    const items = container.getElementsByClassName('event-item');
