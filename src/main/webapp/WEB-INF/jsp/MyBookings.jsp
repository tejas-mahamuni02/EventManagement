	...
	<div class="container-fluid text-center w-75 m-auto p-5 " style="color: #555555;" id="allbookings">
      ...
      <c:otherwise>
		...
		<div class="cards my-5">
			<div class="row row-cols-1 row-cols-md-1 g-4" id="bookingContainer">
					...
					<div class="col booking-item">
						...
						<div class="card p-3 border border-3 bg-light">
							<div class="row row-cols-1 row-cols-md-4  ">
								...
								<div class="col">
									<img src="${booking.event.img1}" class="w-100  rounded mx-auto " alt="...">
								</div>
								<div class="col">
									<img src="${booking.event.img2}" class="w-100  rounded mx-auto " alt="...">
								</div>
								<div class="col">
									<img src="${booking.event.img3}" class="w-100  rounded mx-auto " alt="...">
								</div>
								<div class="col">
									<img src="${booking.event.img4}" class="w-100  rounded mx-auto " alt="...">
								</div>


							</div>
							<h5 class="card-title mt-5">${booking.event.event}</h5>
		...
		<div class="row  g-4 mt-5">
		     ...
		     <a href="bookmarks" class="btn bg-color fs-5 px-5 border border-black fw-bold col-md-3 m-auto">Go To  Bookmarks</a>
   		</div>
